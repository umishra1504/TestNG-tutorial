...
public class DataProvidersTest {
    ...
    public Object[][]  ajaxData(){
        ...
        data[0][0] = "Utkarsh";
        data[0][1] = "Tester Utkarsh";

        data[1][0] = "Varun";
        data[1][1] = "Tester Varun";
    ...
    public void testDataProviderClass(String name, String email, int inputNumber){
        ...
        driver.findElement(By.id("inputEmail4f")).sendKeys(email);
    }
